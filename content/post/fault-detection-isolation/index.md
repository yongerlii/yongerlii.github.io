---
title: Fault Detection and Isolation (FDI) #Welcome to Hugo Blox Builder, the website builder for Hugo
subtitle: ''  #Welcome 👋 We know that first impressions are important, so we've populated your new site with some initial content to help you get familiar with everything in no time.

# Summary for listings and search engines
summary: Welcome 👋 to this research area. #Welcome 👋 We know that first impressions are important, so we've populated your new site with some initial content to help you get familiar with everything in no time.
...
image:
  caption: '**Integrated Energy System (IES)**' #'Image credit: [**Unsplash**](https://unsplash.com/photos/CpkOjOcXdUY)'
  focal_point: ''
  placement: 2
  preview_only: false
...
## **Project**
- 👉 Clicking this **[link](https://github.com/yongerlii/Fault-Detection-and-Isolation)** will take you to the research on **Fault Detection and Isolation (FDI)**.